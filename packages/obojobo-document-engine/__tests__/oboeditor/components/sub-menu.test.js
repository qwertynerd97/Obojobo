...
describe('SubMenu', () => {
	...
	test('SubMenu component edits page name  - cancel without changing', () => {
	...
	test('SubMenu component edits page name  - empty name', () => {
		jest.spyOn(window, 'prompt')
	...
	test('SubMenu component edits page name  - new name', () => {
		jest.spyOn(window, 'prompt')
